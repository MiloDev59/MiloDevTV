...
-- Quelle jeu soit RDR2 ou GTA V
Config.isRDR = IsDuplicityVersion() and GetConvar("gamename", "gta5") == "rdr3" or not TerraingridActivate

-- Distance maximale à laquelle les entités de lecteur multimédia inactives apparaissent
Config.maxDiscoveryDistance = 30.0

-- Multiplicateur d'atténuation sonore par défaut dans la même pièce
Config.defaultSameRoomAttenuation = 4.0

-- Multiplicateur d'atténuation sonore par défaut dans une autre pièce
Config.defaultDiffRoomAttenuation = 6.0

-- Plage par défaut où les lecteurs multimédias actifs sont visibles/audibles
Config.defaultRange = 30.0

-- Portée maximale que les joueurs peuvent définir
Config.maxRange = 200.0

-- Différence entre le volume de base dans la même pièce et une autre pièce
Config.defaultDiffRoomVolume = 0.25

-- Si les options de filtrage sont activées par défaut
Config.enableFilterByDefault = Config.isRDR

-- Taille par défaut pour l'écran vidéo NUI
Config.defaultVideoSize = 30

-- Modèles d'entité sur lesquels les médias peuvent être lus.
--
