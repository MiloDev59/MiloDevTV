...
Citizen.CreateThread(function()
	...
	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix, "Ouvrez le panneau de configuration du lecteur multimédia.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "play", "Jouez quelque chose sur le lecteur multimédia le plus proche.", {
	...
	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "pause", "Mettez en pause le lecteur multimédia le plus proche.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "stop", "Arrêtez le lecteur multimédia le plus proche.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "status", "Afficher/masquer l'état du lecteur multimédia le plus proche.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "presets", "Répertorier les préréglages disponibles.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "vol", "Réglez le volume de base de tous les lecteurs multimédias.", {
		{name = "volume", help = "0-100"}
	})

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "add", "Ajoutez ou modifiez un préréglage de modèle de lecteur multimédia.", {
	...
	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "fix", "Réinitialisez tous les lecteurs multimédias pour résoudre les problèmes.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "ctl", "Contrôle avancé du lecteur multimédia.")

	TriggerEvent("chat:addSuggestion", "/" .. Config.commandPrefix .. Config.commandSeparator .. "refresh_perms", "Actualiser les autorisations pour tous les clients.")
end)
